...
in MicroPython.
As base Elecfreaks code is used from:
  https://github.com/elecfreaks/circuitpython_ef_music/raw/main/elecfreaks_music.py.
Where the Elecfreaks code inspired by the micro:bit `music` module.
"""
...
class Music:
    ...
    def __init__(self, pin: Pin, ticks=4, bpm=120):
        self._ticks = ticks
        self._bpm = bpm
        self._octave = 4
        self._duration = 4
